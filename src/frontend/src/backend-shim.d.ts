/**
 * Re-export of backend types with safe parameter names.
 * backend.ts and backend.d.ts are excluded from tsc but backend.ts (vite-transformed) still works at runtime.
 */
