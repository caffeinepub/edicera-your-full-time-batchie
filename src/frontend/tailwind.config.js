  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        card: "0 4px 32px oklch(0 0 0 / 0.4), 0 1px 3px oklch(0 0 0 / 0.3)",
        glow: "0 0 24px oklch(var(--primary) / 0.3)",
        "glow-sm": "0 0 12px oklch(var(--primary) / 0.2)",
        "glow-amber": "0 0 24px oklch(var(--amber) / 0.3)",
        "inner-glow": "inset 0 1px 0 oklch(1 0 0 / 0.06)",
        elevated: "0 8px 32px oklch(0 0 0 / 0.5), 0 2px 8px oklch(0 0 0 / 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 8px oklch(0.62 0.22 272 / 0.2)" },
          "50%": { boxShadow: "0 0 24px oklch(0.62 0.22 272 / 0.5)" },
        },
        shimmer: {
